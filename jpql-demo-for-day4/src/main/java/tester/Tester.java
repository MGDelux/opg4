...
public class Tester {
    ...
    public static List<Employee> main(String[] args) {
        ...
        try {
            ...
            //5 Create a query to calculate the number of employees and print the number
             TypedQuery<Employee> query5;
            query5 = em.createQuery("Select employee from Employee employee",Employee.class);
            ...
            Query query6 = em.createQuery("Select Employee from employee WHERE MAX(e.salary)   ",Employee.class);
